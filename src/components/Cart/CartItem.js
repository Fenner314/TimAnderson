...
export default function CartItem({ item, cart }) {
	...
	const { handleUpdateCartQuantity, handleRemoveFromCart } =
	...
	return (
		<div className='row my-4 text-center'>
			...
			<div className='col-10 my-1 mx-auto col-lg-2 d-flex justify-content-center align-items-center'>
				<span className='d-lg-none'>Price:&nbsp;</span>${item.price.formatted}
			</div>
			<div className='col-10 my-1 mx-auto col-lg-2 d-flex justify-content-center align-items-center'>
				<div className='d-flex justify-content-center'>
					<div className='quantity-ctrl'>
						<ButtonGroup size='small' className={classes.stepper}>
							...
							<Button disabled className={classes.stepperBox}>
								{item.quantity}
							</Button>
							<Button
								className={classes.stepperBox}
