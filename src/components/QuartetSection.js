    ...
    return (
        <div className="section" id="quartet">
            <div className="heading">
                <h1 className="serif">Elysian Trombone Consort</h1>
            ...
            <div className="quartet-bio">
                ...
                <p className="text-block">The Elysian Trombone Consort is always interested in peforming opportunities, especially in performing newly-composed works. Please &nbsp;
                    <Link 
                        to="footer" 
                        smooth={true} 
                        offset={-49} 
