...
export default function QuartetSection() {
    ...
    const renderMobileParallax = () => {
        if (mobile.matches) {
            return (
                <Background className={'parallax-outer'} bgClassName={'no'} bgImageStyle={{display: 'none'}}>
